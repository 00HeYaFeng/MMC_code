<template>
<uni-shadow-root class="vant-dist-tabs-index"><view :class="'custom-class '+(utils.bem('tabs', [type]))">
...
global['__wxRoute'] = 'vant/dist/tabs/index'
