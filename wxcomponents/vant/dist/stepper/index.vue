<template>
<uni-shadow-root class="vant-dist-stepper-index"><view class="van-stepper custom-class">
...
global['__wxRoute'] = 'vant/dist/stepper/index'
...
export default global['__wxComponents']['vant/dist/stepper/index']
</script>
