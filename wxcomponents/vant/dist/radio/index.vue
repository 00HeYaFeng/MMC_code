<template>
<uni-shadow-root class="vant-dist-radio-index"><view class="van-radio custom-class">
...
global['__wxRoute'] = 'vant/dist/radio/index'
...
export default global['__wxComponents']['vant/dist/radio/index']
</script>
